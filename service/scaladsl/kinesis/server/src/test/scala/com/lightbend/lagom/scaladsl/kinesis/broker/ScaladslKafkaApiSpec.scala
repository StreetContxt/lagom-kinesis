 ...
 */
package com.lightbend.lagom.scaladsl.kinesis.broker
...
import com.lightbend.lagom.scaladsl.broker.kinesis.LagomKinesisComponents
import com.lightbend.lagom.scaladsl.client.ConfigurationServiceLocatorComponents
import com.lightbend.lagom.scaladsl.kinesis.broker.ScaladslKafkaApiSpec.{ InMemoryOffsetStore, TestService, TestServiceImpl }
...
class ScaladslKafkaApiSpec extends WordSpecLike with Matchers with BeforeAndAfterAll with ScalaFutures {
  ...
  private val application = {
    new LagomApplication(LagomApplicationContext.Test) with AhcWSComponents with LagomKinesisComponents with ConfigurationServiceLocatorComponents {
